...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_EQUALTO = 5,                    /* EQUALTO  */
  YYSYMBOL_SEMI_COLON = 6,                 /* SEMI_COLON  */
  YYSYMBOL_OPEN_BRACKET = 7,               /* OPEN_BRACKET  */
  YYSYMBOL_CLOSE_BRACKET = 8,              /* CLOSE_BRACKET  */
  YYSYMBOL_CURLY_BRACE_OPEN = 9,           /* CURLY_BRACE_OPEN  */
  YYSYMBOL_CURLY_BRACE_CLOSE = 10,         /* CURLY_BRACE_CLOSE  */
  YYSYMBOL_SQUARE_BRACKET_OPEN = 11,       /* SQUARE_BRACKET_OPEN  */
  YYSYMBOL_SQUARE_BRACKET_CLOSE = 12,      /* SQUARE_BRACKET_CLOSE  */
  YYSYMBOL_CHARACTER_VALUE = 13,           /* CHARACTER_VALUE  */
  YYSYMBOL_INT_VALUE = 14,                 /* INT_VALUE  */
  YYSYMBOL_STRING_VALUE = 15,              /* STRING_VALUE  */
  YYSYMBOL_INT = 16,                       /* INT  */
  YYSYMBOL_STRING = 17,                    /* STRING  */
  YYSYMBOL_DATA_TYPE = 18,                 /* DATA_TYPE  */
  YYSYMBOL_IDENTIFIER = 19,                /* IDENTIFIER  */
  YYSYMBOL_ARRAY_IDENTIFIER = 20,          /* ARRAY_IDENTIFIER  */
  YYSYMBOL_21_ = 21,                       /* '>'  */
...
static const char *const yytname[] =
{
  ...
  "EQUALTO", "SEMI_COLON", "OPEN_BRACKET", "CLOSE_BRACKET",
  "CURLY_BRACE_OPEN", "CURLY_BRACE_CLOSE", "SQUARE_BRACKET_OPEN",
  "SQUARE_BRACKET_CLOSE", "CHARACTER_VALUE", "INT_VALUE", "STRING_VALUE",
  "INT", "STRING", "DATA_TYPE", "IDENTIFIER", "ARRAY_IDENTIFIER", "'>'",
  "$accept", "DECLARATION", "EXPRESSION", "NUMBER", "PARAMETERS", YY_NULLPTR
};
...
{
       2,   -13,    -6,     5,     0,    19,    23,   -19,   -19,     3,
     -19,     7,    27,    15,    31,   -19,   -19,   -19,   -19,   -19,
     -19,   -19,    -5,     1,   -19,    11,    32,     4,   -19,     3,
       3,   -19,   -19,   -19
};
...
{
       0,     0,     0,     0,     0,     0,     4,     5,     9,     0,
       1,     0,     0,     0,     0,     2,    13,     7,    12,     3,
       8,    11,     0,     0,     6,     0,    14,     0,    17,     0,
       0,    10,    16,    15
};
...
{
      10,    11,    25,     1,    24,    26,    23,    30,     6,    16,
       9,    32,    33,     7,     8,    16,    31,    16,     2,     3,
       2,     3,    13,    14,    12,    15,   -12,   -12,    18,   -12,
      13,    14,    28,    19,    20,    21,    22,    29
};

static const yytype_int8 yycheck[] =
{
       0,     1,     1,     1,    22,    23,    11,     3,    21,    14,
       5,    29,    30,    19,    20,    14,    12,    14,    18,    19,
      18,    19,     3,     4,     4,     6,     3,     4,    21,     6,
       3,     4,    21,     6,    19,    20,     5,     5
};
...
{
       0,     1,    18,    19,    23,    24,    21,    19,    20,     5,
       0,     1,    24,     3,     4,     6,    14,    25,    21,     6,
      19,    20,     5,    11,    25,     1,    25,    26,    21,     5,
       3,    12,    25,    25
};
